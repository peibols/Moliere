...
double front0_(double dk,double kcm,double x,double pin,double g,double d)
{
    double kmin=kmin_(kcm,x,pin);
    return exp(-dk-kmin)*kmin/x/(1+g*exp(-dk-kmin))/ (1+d*exp(-dk-kcm));
}
double frontdk_(double dk,double kcm,double x,double pin,double g,double d,double n)
{
    // if (x>1) return 0;
    double kmin=kmin_(kcm,x,pin);
    ...
    return exp(-kmin)*powdiff(-d*exp(-kcm),-g*exp(-kmin),n)*kmin/x;
}
...
double m1dk(double dk,double kcm,double x,double pin,double g,double d,double n,gsl_integration_workspace *w )
{
    ...
    double frontdk=frontdk_(dk,kcm,x,pin,g,d,n);
...
double m2dk(double dk,double kcm,double x,double pin,double g,double d,double n,gsl_integration_workspace *w ) 
{
...
double m3dk(double dk,double kcm,double x,double pin,double g,double d,double n,gsl_integration_workspace *w ) 
{
...
double m4dk(double dk,double kcm,double x,double pin,double g,double d,double n,gsl_integration_workspace *w ) 
{
...
double m5dk(double dk,double kcm,double x,double pin,double g,double d,double n,gsl_integration_workspace *w ) 
{
...
double m6dk(double dk,double kcm,double x,double pin,double g,double d,double n,gsl_integration_workspace *w ) 
{
...
double special(double dk, double kcm, double x, double pin, double n,gsl_integration_workspace *w )
{
    ...
    double psis=M_PI;
    if (M==0) return exp(-n*P)/(P-s)*(psi-M_PI);
    if (P-s>M) return expKint(P,M,psi,0,0,n,w,-s)*M_PI;
    ...
    gsl_integration_qags(&F, M_PI, std::max(pole + .00001, psi), epsabs, epsrel, limit, w, &result1, &abserr);
    gsl_integration_qags(&F, pole - .00001, std::min(psi, pole - .00001), epsabs, epsrel, limit, w, &result2, &abserr);
...
double m7dk(double dk,double kcm,double x,double pin,double g,double d,double n,gsl_integration_workspace *w ) 
{
    ...
    //     exit(EXIT_FAILURE);
    // }
    m7dk_2+=q/M_PI*n/2*(Z*Z-q*q*(1+x))*special(dk,kcm,x,pin,n,w)*mine;
    // if (m7dk_2!=m7dk_2) 
    // {
    //     std::cout << "m7dk2 failure 5"<< std::endl;
    //     exit(EXIT_FAILURE);
    // }
...
double m1phi(double phi,double dk,double kcm,double x,double pin,double g,double d)//bounds 0-2pi
{
    //  std::cout << "starting m1phi" << std::endl;
    double C=C_(dk,kcm,x,pin);
    double D=D_(dk,kcm,x,pin);
    double front0=front0_(dk,kcm,x,pin,g,d);
    double kp=dkpm(1,kcm,x,pin);
    double km=dkpm(-1,kcm,x,pin);
    double n=2;
...
double m2phi(double phi,double dk,double kcm,double x,double pin,double g,double d) //bounds 0-2pi
{
...
double m3phi(double phi,double dk,double kcm,double x,double pin,double g,double d) //bounds 0-2pi
{
...
double m4phi(double phi,double dk,double kcm,double x,double pin,double g,double d) //bounds 0-2pi
{
...
double m5phi(double phi,double dk,double kcm,double x,double pin,double g,double d) //bounds 0-2pi
{
...
double m6phi(double phi,double dk,double kcm,double x,double pin,double g,double d)//bounds 0-2pi
{
...
double m7phi(double phi,double dk,double kcm,double x,double pin,double g,double d) //bounds 0-2pi
{
...
double m1base(double phi,double dk,double kcm,double x,double pin,double g,double d)
{
...
double m2base(double phi,double dk,double kcm,double x,double pin,double g,double d)
{
...
double m3base(double phi,double dk,double kcm,double x,double pin,double g,double d)
{
    double front0=front0_(dk,kcm,x,pin,g,d);
    return front0/(2 * M_PI)*Vu(phi,dk,kcm,x,pin);
}
double m4base(double phi,double dk,double kcm,double x,double pin,double g,double d)
{
...
double m5base(double phi,double dk,double kcm,double x,double pin,double g,double d)
{
    double C=C_(dk,kcm,x,pin);
    double D=D_(dk,kcm,x,pin);
    double front0=front0_(dk,kcm,x,pin,g,d);
...
double m6base(double phi,double dk,double kcm,double x,double pin,double g,double d)
{
...
double m7base(double phi,double dk,double kcm,double x,double pin,double g,double d)
{
...
struct makcm_params {double x;double pin;double g;double d;double n; double a;gsl_integration_workspace *w;};
...
double makcm_f (double y, void * p)
{
    ...
    if (a==1) return m1dk(inf,y,x,pin,g,d,n,w)-m1dk(0,y,x,pin,g,d,n,w);
    if (a==2) return m2dk(inf,y,x,pin,g,d,n,w)-m2dk(0,y,x,pin,g,d,n,w);
    if (a==3) return m3dk(inf,y,x,pin,g,d,n,w)-m3dk(0,y,x,pin,g,d,n,w);
    if (a==4) return m4dk(inf,y,x,pin,g,d,n,w)-m4dk(0,y,x,pin,g,d,n,w);
    if (a==5) return m5dk(inf,y,x,pin,g,d,n,w)-m5dk(0,y,x,pin,g,d,n,w);
    if (a==6) return m6dk(inf,y,x,pin,g,d,n,w)-m6dk(0,y,x,pin,g,d,n,w);
...
double m2kcm(double kcm,double x,double pin,double g,double d,double n,gsl_integration_workspace *wdk, gsl_integration_workspace *wkcm )
{
    // if (kcmres<kcm)
    // {
...
double m3kcm(double kcm,double x,double pin,double g,double d,double n,gsl_integration_workspace *wdk, gsl_integration_workspace *wkcm )
{
    // if (kcmres<kcm)
    // {
...
double m4kcm(double kcm,double x,double pin,double g,double d,double n,gsl_integration_workspace *wdk, gsl_integration_workspace *wkcm )
{
    // if (kcmres<kcm)
    // {
    ...
    // exit(EXIT_FAILURE);
    gsl_function F;
    struct makcm_params params = {x,pin,g,d,n,4,wdk};
...
double m5kcm(double kcm,double x,double pin,double g,double d,double n,gsl_integration_workspace *wdk, gsl_integration_workspace *wkcm)
{
    // if (kcmres<kcm)
    // {
...
double m6kcm(double kcm,double x,double pin,double g,double d,double n,gsl_integration_workspace *wdk, gsl_integration_workspace *wkcm)
{
    // if (kcmres<kcm)
    // {
...
double m7kcm(double kcm,double x,double pin,double g,double d,double n,gsl_integration_workspace *wdk, gsl_integration_workspace *wkcm)
{
    // if (kcmres<kcm)
    // {
...
struct max_params {double pin;double g;double d;double n; double a;gsl_integration_workspace *wdk;gsl_integration_workspace *wkcm;};
...
double max_f (double y, void * p)
{
    ...
    if (a==1) return m1kcm(pin,y,pin,g,d,n,wdk,wkcm)-m1kcm(0,y,pin,g,d,n,wdk,wkcm);
    if (a==2) return m2kcm(pin,y,pin,g,d,n,wdk,wkcm)-m2kcm(0,y,pin,g,d,n,wdk,wkcm);
    if (a==3) return m3kcm(pin,y,pin,g,d,n,wdk,wkcm)-m3kcm(0,y,pin,g,d,n,wdk,wkcm);
    if (a==4) return m4kcm(pin,y,pin,g,d,n,wdk,wkcm)-m4kcm(0,y,pin,g,d,n,wdk,wkcm);
    if (a==5) return m5kcm(pin,y,pin,g,d,n,wdk,wkcm)-m5kcm(0,y,pin,g,d,n,wdk,wkcm);
    if (a==6) return m6kcm(pin,y,pin,g,d,n,wdk,wkcm)-m6kcm(0,y,pin,g,d,n,wdk,wkcm);
    if (a==7) return m7kcm(pin,y,pin,g,d,n,wdk,wkcm)-m7kcm(0,y,pin,g,d,n,wdk,wkcm);
}
...
double m1x(double x,double pin,double g,double d,double n,gsl_integration_workspace *wdk,gsl_integration_workspace *wkcm,gsl_integration_workspace *wx ) 
{
    ...
    if (use_tables) return do_interp(1, x, pin, int(g), int(d), int(n));

    gsl_function F;
    struct max_params params = {pin,g,d,n,1,wdk,wkcm};
    if (x!=x)
    {
...
double m2x(double x,double pin,double g,double d,double n,gsl_integration_workspace *wdk,gsl_integration_workspace *wkcm,gsl_integration_workspace *wx )
{
    if (x==0) return 0;
    
    if (use_tables) return do_interp(2, x, pin, int(g), int(d), int(n));
    
    gsl_function F;
    struct max_params params = {pin,g,d,n,2,wdk,wkcm};
...
double m3x(double x,double pin,double g,double d,double n,gsl_integration_workspace *wdk,gsl_integration_workspace *wkcm,gsl_integration_workspace *wx )
{
    if (x==0) return 0;

    if (use_tables) return do_interp(3, x, pin, int(g), int(d), int(n));
  
    gsl_function F;
    struct max_params params = {pin,g,d,n,3,wdk,wkcm};
...
double m4x(double x,double pin,double g,double d,double n,gsl_integration_workspace *wdk,gsl_integration_workspace *wkcm,gsl_integration_workspace *wx )
{
    if (x==0) return 0;

    if (use_tables) return do_interp(4, x, pin, int(g), int(d), int(n));
   
    gsl_function F;
    struct max_params params = {pin,g,d,n,4,wdk,wkcm};
...
double m5x(double x,double pin,double g,double d,double n,gsl_integration_workspace *wdk,gsl_integration_workspace *wkcm,gsl_integration_workspace *wx )
{
    if (x==0) return 0;
    
    if (use_tables) return do_interp(5, x, pin, int(g), int(d), int(n));
    
    gsl_function F;
    struct max_params params = {pin,g,d,n,5,wdk,wkcm};
...
double m6x(double x,double pin,double g,double d,double n,gsl_integration_workspace *wdk,gsl_integration_workspace *wkcm,gsl_integration_workspace *wx )
{
    if (x==0) return 0;
    
    if (use_tables) return do_interp(6, x, pin, int(g), int(d), int(n));
    
    gsl_function F;
    struct max_params params = {pin,g,d,n,6,wdk,wkcm};
...
double m7x(double x,double pin,double g,double d,double n,gsl_integration_workspace *wdk,gsl_integration_workspace *wkcm,gsl_integration_workspace *wx )
{
    if (x==0) return 0;

    if (use_tables) return do_interp(7, x, pin, int(g), int(d), int(n));

    gsl_function F;
    struct max_params params = {pin,g,d,n,7,wdk,wkcm};
...
double m1tot(double phi,double dk,double kcm,double x,double pin,double g,double d,double dist,gsl_integration_workspace *wdk,gsl_integration_workspace *wkcm,gsl_integration_workspace *wx,double n=0) //dist is # of un-intgrated variables (0 for PhiKThetaP,1 for PhiKTheta,2 for PhiK,3 for Phi,4 for all 4 left)
{
    //return 0; //DEBUG
    ...
    if (dist==0) return m1x(x,pin,g,d,n,wdk,wkcm,wx)-m1x(0,pin,g,d,n,wdk,wkcm,wx);
    if (dist==1) return m1kcm(kcm,x,pin,g,d,n,wdk,wkcm)-m1kcm(0,x,pin,g,d,n,wdk,wkcm);
    if (dist==2) return m1dk(dk,kcm,x,pin,g,d,n,wdk)-m1dk(0,kcm,x,pin,g,d,n,wdk);
    if (dist==3) return m1phi(phi,dk,kcm,x,pin,g,d)-m1phi(0,dk,kcm,x,pin,g,d);
    if (dist==4) return m1base(phi,dk,kcm,x,pin,g,d);
    std::cout<<"m1tot issue"<<std::endl;
    exit(EXIT_FAILURE);
}
double m2tot(double phi,double dk,double kcm,double x,double pin,double g,double d,double dist,gsl_integration_workspace *wdk,gsl_integration_workspace *wkcm,gsl_integration_workspace *wx,double n=0)
{
    //return 0; //DEBUG
    if(!wdk)
    {
    ...
    if (dist==0) return m2x(x,pin,g,d,n,wdk,wkcm,wx)-m2x(0,pin,g,d,n,wdk,wkcm,wx);
    if (dist==1) return m2kcm(kcm,x,pin,g,d,n,wdk,wkcm)-m2kcm(0,x,pin,g,d,n,wdk,wkcm);
    if (dist==2) return m2dk(dk,kcm,x,pin,g,d,n,wdk)-m2dk(0,kcm,x,pin,g,d,n,wdk);
    if (dist==3) return m2phi(phi,dk,kcm,x,pin,g,d)-m2phi(0,dk,kcm,x,pin,g,d);
    if (dist==4) return m2base(phi,dk,kcm,x,pin,g,d);
    std::cout<<"m2tot issue"<<std::endl;
    exit(EXIT_FAILURE);
}
double m3tot(double phi,double dk,double kcm,double x,double pin,double g,double d,double dist,gsl_integration_workspace *wdk,gsl_integration_workspace *wkcm,gsl_integration_workspace *wx,double n=0)
{
    //return 0; //DEBUG
    if(!wdk)
    {
    ...
    if (dist==0) return m3x(x,pin,g,d,n,wdk,wkcm,wx)-m3x(0,pin,g,d,n,wdk,wkcm,wx);
    if (dist==1) return m3kcm(kcm,x,pin,g,d,n,wdk,wkcm)-m3kcm(0,x,pin,g,d,n,wdk,wkcm);
    if (dist==2) return m3dk(dk,kcm,x,pin,g,d,n,wdk)-m3dk(0,kcm,x,pin,g,d,n,wdk);
    if (dist==3) return m3phi(phi,dk,kcm,x,pin,g,d)-m3phi(0,dk,kcm,x,pin,g,d);
    if (dist==4) return m3base(phi,dk,kcm,x,pin,g,d);
    std::cout<<"m3tot issue"<<std::endl;
    exit(EXIT_FAILURE);
}
double m4tot(double phi,double dk,double kcm,double x,double pin,double g,double d,double dist,gsl_integration_workspace *wdk,gsl_integration_workspace *wkcm,gsl_integration_workspace *wx,double n=0)
{
    //return 0; //DEBUG
    if(!wdk)
    {
    ...
    if (dist==0) return m4x(x,pin,g,d,n,wdk,wkcm,wx)-m4x(0,pin,g,d,n,wdk,wkcm,wx);
    if (dist==1) return m4kcm(kcm,x,pin,g,d,n,wdk,wkcm)-m4kcm(0,x,pin,g,d,n,wdk,wkcm);
    if (dist==2) return m4dk(dk,kcm,x,pin,g,d,n,wdk)-m4dk(0,kcm,x,pin,g,d,n,wdk);
    if (dist==3) return m4phi(phi,dk,kcm,x,pin,g,d)-m4phi(0,dk,kcm,x,pin,g,d);
    if (dist==4) return m4base(phi,dk,kcm,x,pin,g,d);
    std::cout<<"m4tot issue"<<std::endl;
    exit (EXIT_FAILURE);
}
double m5tot(double phi,double dk,double kcm,double x,double pin,double g,double d,double dist,gsl_integration_workspace *wdk,gsl_integration_workspace *wkcm,gsl_integration_workspace *wx,double n=0)
{
    //return 0; //DEBUG
    if(!wdk)
    {
    ...
    if (dist==0) return m5x(x,pin,g,d,n,wdk,wkcm,wx)-m5x(0,pin,g,d,n,wdk,wkcm,wx);
    if (dist==1) return m5kcm(kcm,x,pin,g,d,n,wdk,wkcm)-m5kcm(0,x,pin,g,d,n,wdk,wkcm);
    if (dist==2) return m5dk(dk,kcm,x,pin,g,d,n,wdk)-m5dk(0,kcm,x,pin,g,d,n,wdk);
    if (dist==3) return m5phi(phi,dk,kcm,x,pin,g,d)-m5phi(0,dk,kcm,x,pin,g,d);
    if (dist==4) return m5base(phi,dk,kcm,x,pin,g,d);
    std::cout<<"m5tot issue"<<std::endl;
    exit(EXIT_FAILURE);
}
double m6tot(double phi,double dk,double kcm,double x,double pin,double g,double d,double dist,gsl_integration_workspace *wdk,gsl_integration_workspace *wkcm,gsl_integration_workspace *wx,double n=0)
{
    //return 0; //DEBUG
    if(!wdk)
    {
    ...
    if (dist==0) return m6x(x,pin,g,d,n,wdk,wkcm,wx)-m6x(0,pin,g,d,n,wdk,wkcm,wx);
    if (dist==1) return m6kcm(kcm,x,pin,g,d,n,wdk,wkcm)-m6kcm(0,x,pin,g,d,n,wdk,wkcm);
    if (dist==2) return m6dk(dk,kcm,x,pin,g,d,n,wdk)-m6dk(0,kcm,x,pin,g,d,n,wdk);
    if (dist==3) return m6phi(phi,dk,kcm,x,pin,g,d)-m6phi(0,dk,kcm,x,pin,g,d);
    if (dist==4) return m6base(phi,dk,kcm,x,pin,g,d);
    std::cout<<"m6tot issue"<<std::endl;
    exit(EXIT_FAILURE);
}
double m7tot(double phi,double dk,double kcm,double x,double pin,double g,double d,double dist,gsl_integration_workspace *wdk,gsl_integration_workspace *wkcm,gsl_integration_workspace *wx,double n=0)
{
    //return 0; //DEBUG
    if(!wdk)
    {
    ...
    if (dist==0) return m7x(x,pin,g,d,n,wdk,wkcm,wx)-m7x(0,pin,g,d,n,wdk,wkcm,wx);
    if (dist==1) return m7kcm(kcm,x,pin,g,d,n,wdk,wkcm)-m7kcm(0,x,pin,g,d,n,wdk,wkcm);
    if (dist==2) return m7dk(dk,kcm,x,pin,g,d,n,wdk)-m7dk(0,kcm,x,pin,g,d,n,wdk);
    if (dist==3) return m7phi(phi,dk,kcm,x,pin,g,d)-m7phi(0,dk,kcm,x,pin,g,d);
    if (dist==4) return m7base(phi,dk,kcm,x,pin,g,d);
    std::cout<<"m7tot issue"<<std::endl;
    exit(EXIT_FAILURE);
}
std::vector<double> meval(double phi,double dk,double kcm,double x,double pin,double g,double d,double dist,gsl_integration_workspace *wdk,gsl_integration_workspace *wkcm,gsl_integration_workspace *wx)
{//This combines some of the sums in mtp in order to speed up runtime and cleans up the rest
    ...
    if (dist <=2)
    {
	    ...
	    //if (n>15) break; //DEBUG
            pinc=inc;
            inc=m1tot(phi,dk,kcm,x,pin,g,d,dist,wdk,wkcm,wx,n);
            sum1+=inc;
	...
	inc=1000;
	    ...
	    //if (n>15) break; //DEBUG
            pinc=inc;
            inc=m2tot(phi,dk,kcm,x,pin,g,d,dist,wdk,wkcm,wx,n);
            sum2+=inc;
	    ...
	    //if (n>15) break; //DEBUG
            pinc=inc;
            inc=m3tot(phi,dk,kcm,x,pin,g,d,dist,wdk,wkcm,wx,n);
            sum3+=inc;
	    ...
	    //if (n>15) break; //DEBUG
            pinc=inc;
            inc=m4tot(phi,dk,kcm,x,pin,g,d,dist,wdk,wkcm,wx,n);
            sum4+=inc;
	    ...
	    //if (n>15) break; //DEBUG
            pinc=inc;
            inc=m5tot(phi,dk,kcm,x,pin,g,d,dist,wdk,wkcm,wx,n);
            sum5+=inc;
	    ...
	    //if (n>15) break; //DEBUG
            pinc=inc;
            inc=m6tot(phi,dk,kcm,x,pin,g,d,dist,wdk,wkcm,wx,n);
            sum6+=inc;
	    ...
	    //if (n>15) break; //DEBUG
            pinc=inc;
            inc=m7tot(phi,dk,kcm,x,pin,g,d,dist,wdk,wkcm,wx,n);
    ...
    return {eta*m1tot(phi,dk,kcm,x,pin,g,d,dist,wdk,wkcm,wx,0),eta*m2tot(phi,dk,kcm,x,pin,g,d,dist,wdk,wkcm,wx,0),eta*m3tot(phi,dk,kcm,x,pin,g,d,dist,wdk,wkcm,wx,0),eta*m4tot(phi,dk,kcm,x,pin,g,d,dist,wdk,wkcm,wx,0),eta*m5tot(phi,dk,kcm,x,pin,g,d,dist,wdk,wkcm,wx,0),eta*m6tot(phi,dk,kcm,x,pin,g,d,dist,wdk,wkcm,wx,0),eta*m7tot(phi,dk,kcm,x,pin,g,d,dist,wdk,wkcm,wx,0)};
...
std::vector<double> Proc1_qq_qq()
{
    ...
    return {C1,C1-C2,C1+C2,0,0,-C1-C2,C1};
}
...
std::vector<double> Proc3twid_qqb_qqb()
{
    ...
    return {0,0,C1,C1-C2,C1,-C1+C2,C1};
...
{//<the first return index is the probability,-1 for gluon,1 for quark,2 for QBar for each of the two indices.
    std::vector<double> mQQ=meval(phi,dk,kcm,x,pin,Q,Q,dist,wdk,wkcm,wx);
    std::vector<double> mGG = meval(phi, dk, kcm, x, pin, G, G, dist,wdk,wkcm,wx);
    double c1=1;
    double c2=1;
    if (abs(charm)==4)
    {
...
{
    std::vector<double> mQG=meval(phi,dk,kcm,x,pin,Q,G,dist,wdk,wkcm,wx);
    std::vector<double> mGQ=meval(phi,dk,kcm,x,pin,G,Q,dist,wdk,wkcm,wx);
    double c1=1;
    if (abs(charm)==4) c1=0;
    double kap=pow(gs,4)*deltime;
...
std::vector<double> is_split(double pin, double deltime, double pinPDG, gsl_integration_workspace *wdk, gsl_integration_workspace *wkcm, gsl_integration_workspace *wx)
{
    ...
    if (pintype==Q)
    {
        ...
        FQQB*=corr;
        prob*=corr;
        if (prob>=.5) return {-1,.5,0,0,prob};//-1 means to half the global time step and run again

        if (prob<=.05) b=2; //means double the global time step on the next run
        double guess=distcon(generator);
         //cout<<guess<<"  "<<prob<<std::endl;
        
        if (guess>=prob) return {0,b,0,0,prob}; //0 means no splitting this interval //b is checker of time step
        if (guess<=FQQ) return {1,b,1,FQQ_[1],prob};
        if (guess<=(FQQ+FQG)) return {1,b,2,FQG_[1],prob};
        if (guess<=prob) return {1,b,3,FQQB_[1],prob};
	...
	//std::cout << " All_time = " << all_time << std::endl;
        ...
        FGG*=corr;
        prob*=corr;
        if (prob>=.5) return {-1,.5,0,0,prob};
        if (prob<=.05) b=2;
        double guess=distcon(generator);
        //cout<<guess<<"    "<<prob<<std::endl;

        if (guess>=prob) return {0,b,0,0,prob}; //0 means no splitting this interval
        if (guess<=FGQ) return {1,b,4,FGQ_[1],prob};
        if (guess<=prob) return {1,b,5,FGG_[1],prob};
    }
    std::cout<<"is_split is having issues"<<std::endl;
    exit(EXIT_FAILURE);
}
double myproc(double phi,double dk,double kcm,double x,double pin,double g,double d,double dist,double proc,gsl_integration_workspace *wdk,gsl_integration_workspace *wkcm,gsl_integration_workspace *wx)
{
    std::vector<double> m=meval(phi,dk,kcm,x,pin,g,d,dist,wdk,wkcm,wx);
    if (proc==1) return dot(m,Proc1_qq_qq());
    if (proc==3) return dot(m,Proc3_qqb_qqb());
    if (proc==-3) return dot(m,Proc3twid_qqb_qqb());
    if (proc==4) return dot(m,Proc4_qqp_qqp());
    if (proc==-4) return dot(m,Proc4twid_qqp_qqp());
    if (proc==7) return dot(m,Proc7_qqb_qpqbp());
    if (proc==8) return dot(m,Proc8_qqb_gg());
    if (proc==9) return dot(m,Proc9_qg_qg());
    if (proc==-9) return dot(m,Proc9twid_qg_qg());
    if (proc==11) return dot(m,Proc11_gg_gg());
...
double gen_phi(double dk,double kcm,double x,double pin,double g,double d,double proc,gsl_integration_workspace *wdk,gsl_integration_workspace *wkcm,gsl_integration_workspace *wx)
{
    double l=0;
    double h=2*M_PI;
    double guess=distcon(generator) * myproc(h,dk,kcm,x,pin,g,d,3,proc,wdk,wkcm,wx);
    while ((h-l)*2/(h+l)>ep/1000)
    {
        double mid=(h+l) / 2;
        double proc_temp=myproc(mid,dk,kcm,x,pin,g,d,3,proc,wdk,wkcm,wx);
        if (proc_temp > guess) h=mid;
        if (proc_temp < guess) l=mid;
    }
    return (h+l)/2;
}
double gen_dk(double kcm,double x,double pin,double g,double d,double proc,gsl_integration_workspace *wdk,gsl_integration_workspace *wkcm,gsl_integration_workspace *wx)
{
    double l=0;
    double h=pin*10;
    double guess=distcon(generator) * myproc(0,h,kcm,x,pin,g,d,2,proc,wdk,wkcm,wx);
    //while (myproc(0,inf,kcm,x,pin,g,d,2,proc)<guess) h*=2;
    while ((h-l)*2/(h+l)>ep/1000)
    {
        double mid=(h+l) / 2;
	double proc_temp=myproc(0,mid,kcm,x,pin,g,d,2,proc,wdk,wkcm,wx);
        if (proc_temp > guess) h=mid;
        if (proc_temp < guess) l=mid;
    }
    return (h+l)/2;
}
double gen_kcm(double x,double pin,double g,double d,double proc,gsl_integration_workspace *wdk,gsl_integration_workspace *wkcm,gsl_integration_workspace *wx)
{
    double l=0;
    double h=pin;
    double guess=distcon(generator) * myproc(0,0,h,x,pin,g,d,1,proc,wdk,wkcm,wx);
    while ((h-l)*2/(h+l)>ep/1000)
    {
        double mid=(h+l) / 2;
	double proc_temp=myproc(0,0,mid,x,pin,g,d,1,proc,wdk,wkcm,wx);
        if (proc_temp > guess) h=mid;
        if (proc_temp < guess) l=mid;
    }
    return (h+l)/2;
}
double gen_x(double pin,double g,double d,double proc,gsl_integration_workspace *wdk,gsl_integration_workspace *wkcm,gsl_integration_workspace *wx)
{
    double l=0;
    double h=1;
    double guess=distcon(generator) * myproc(0,0,0,1,pin,g,d,0,proc,wdk,wkcm,wx);
    while ((h-l)*2/(h+l)>ep/1000)
    {
        double mid=(h+l) / 2;
        //cout<<h-l<<std::endl;
        double proc_temp=myproc(0,0,0,mid,pin,g,d,0,proc,wdk,wkcm,wx);
        if (proc_temp > guess) h=mid;
        if (proc_temp < guess) l=mid;
    }
    return (h+l)/2;
...
*/
std::vector<double> kinematics(double pinx, double piny, double pinz, double g, double d, double proc,gsl_integration_workspace *wdk,gsl_integration_workspace *wkcm,gsl_integration_workspace *wx) // after we calculate that a new particle is necessary,this generates it at that point
{
    double pin=sqrt(pinx*pinx+piny*piny+pinz*pinz);

    double x=gen_x(pin,g,d,proc,wdk,wkcm,wx);
    double kcm=gen_kcm(x,pin,g,d,proc,wdk,wkcm,wx);
    double dk=gen_dk(kcm,x,pin,g,d,proc,wdk,wkcm,wx);
    double phi=gen_phi(dk,kcm,x,pin,g,d,proc,wdk,wkcm,wx);

    double theta=theta_(kcm,x,pin);
    double k=k_(dk,kcm,x,pin);
    double p=p_(kcm,x,pin);
    ...
    double utwid=amD2/x*(Cu_(dk,kcm,x,pin)-D_(dk,kcm,x,pin)*cos(phi));
...
std::vector<double> gen_particles(double pinx, double piny, double pinz, double pinPDG, double deltime,gsl_integration_workspace *wdk,gsl_integration_workspace *wkcm,gsl_integration_workspace *wx) // split_or_nah,timechange,px,py,pz,pPDG,kx,ky,kz,kPDG,E4x,E4y,E4z,E4PDG
{
    ...
    double split_or_nah=out[0]; double timechange=out[1]; double myF=out[2]; double myproc=out[3];
    ...
    std::vector<double> out1=kinematics(pinx,piny,pinz,QG1,QG2,myproc,wdk,wkcm,wx);
